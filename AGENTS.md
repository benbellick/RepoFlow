...
- **Repository IDs.** All repository owners and names are stored and processed in lowercase (normalized). This invariant is enforced at system boundaries (API parsing, config loading).
